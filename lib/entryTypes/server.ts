...
const DESCRIPTORS = {
  labour: {
    ...
    listColumns: {
      ...
      otPeopleCount: sql<number | null>`(to_jsonb(labour_entries)->>'ot_people_count')::int`,
      otHours: sql<string | null>`to_jsonb(labour_entries)->>'ot_hours'`,
      otRate: sql<string | null>`to_jsonb(labour_entries)->>'ot_rate'`,
      otTotalAmount: sql<string | null>`to_jsonb(labour_entries)->>'ot_total_amount'`,
